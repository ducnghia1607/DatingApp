...
public class AdminController : BaseApiController
{
    ...
    {
        if (String.IsNullOrEmpty(roles)) return BadRequest("Must choose at least one role");
    ...
    [Authorize(Policy = "RequiredModeratorOrAdminRole")]
    [HttpGet("photos-to-moderate")]
    public ActionResult GetPhotosToModeration()
    {
        return Ok("Admins or moderator  can access this");
    }
